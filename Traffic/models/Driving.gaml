...
global {
//	file shapefile_roads <- file("../includes/HqvTraffic/roadhqv.shp");
	file shapefile_roads <- file("../includes/bbbike/roadts.shp");
//	file shapefile_lanes <- file("../includes/bbbike/roads.shp");
	file shapefile_shelters <- file("../includes/bbbike/buildings.shp");
